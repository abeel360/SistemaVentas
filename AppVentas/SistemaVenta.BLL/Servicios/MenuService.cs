...
namespace SistemaVenta.BLL.Servicios
{
    public class MenuService : IMenuService
    {
        ...
        public MenuService(DAL.Repositorios.Contrato.IGenericRepository<Usuario> usuarioRepository, IGenericRepository<MenuRol> menurolRepositorio, IGenericRepository<Menu> menuRepositorio, IMapper mapper)
        {
