...
namespace SistemaVenta.Utility
{
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile()
        {
            ...
            .ForMember(dest => dest.Nombre, opt => opt.MapFrom(src => src.Archivo.Nombre))
            .ForMember(dest => dest.Extension, opt => opt.MapFrom(src => src.Archivo.Extension))
            .ForMember(dest => dest.ArchivoContenido, opt => opt.MapFrom(src => src.Archivo.ArchivoContenido))
